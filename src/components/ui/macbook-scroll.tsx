...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="min-h-[200vh] w-full flex flex-col items-center py-20 md:py-40"
    >
      {/* Title */}
      <motion.h2
        style={{
        ...
        className="mb-10 md:mb-20 text-center text-3xl md:text-5xl font-bold text-white px-4"
      >
        {title || (
          <span>
            Our Work Speaks <br />
      ...
      >
        ...
        <div className="relative -z-10 h-[22rem] w-[32rem] overflow-hidden rounded-2xl bg-gray-200 dark:bg-[#272729]">
          ...
          {showGradient && (
            <div className="absolute inset-x-0 bottom-0 z-50 h-40 w-full bg-gradient-to-t from-[#030014] via-[#030014] to-transparent"></div>
          )}
      ...
      <motion.div 
        className="mt-8 flex flex-col items-center gap-4 z-20 px-4 md:hidden"
      ...
      >
        ...
        <div className="flex items-center gap-4">
          <button
            onClick={prevProject}
            className="group flex h-10 w-10 items-center justify-center rounded-full border border-white/10 bg-white/5 backdrop-blur-sm transition-all hover:bg-white/10 hover:border-white/20"
          >
        ...
        {projects[activeProject]?.link && (
          <motion.a
            ...
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            className="mt-2 text-sm text-blue-400 hover:text-blue-300 transition-colors underline underline-offset-4"
          >
            View Live Project →
          </motion.a>
        )}
