...
export const FullScreenScrollFX = forwardRef<HTMLDivElement, FullScreenFXProps>(
  (
    ...
    const cssVars: CSSProperties = {
      ...
      ["--fx-page-bg" as string]: colors.pageBg ?? "#030014",
      ["--fx-stage-bg" as string]: colors.stageBg ?? "#030014",
      ...
      >
        ...
        <style jsx>{`
          ...
          .fx-header {
            ...
            font-size: clamp(1.5rem, 5vw, 4rem); line-height: 0.9; text-align: center; color: var(--fx-text);
          }
          ...
          .fx-footer-title { color: var(--fx-text); font-size: clamp(1.2rem, 4vw, 3rem); font-weight: 800; letter-spacing: -0.01em; line-height: 0.9; }
