...
export function HeroSection() {
  ...
  return (
    <div
      className="h-screen bg-gradient-to-br from-[#1a1d18] via-black to-[#2a2e26] text-[#e6e1d7] overflow-hidden relative w-full"
    >
      ...
      <div className="relative z-10 h-full flex flex-col justify-between items-center px-8 pt-32 pb-12 md:px-16 md:pt-40 md:pb-20">
        ...
        <div className="text-center max-w-5xl mx-auto">
          ...
          >
            <div className="mb-4 md:mb-6">
              ...
              <span className="word" data-delay="2550">
                convert.
              </span>
            </div>
            <div
            ...
            >
              ...
              <span className="word" data-delay="3550">
                under
              </span>
              <span className="word" data-delay="3700">
                one
              </span>
              <span className="word" data-delay="3850">
                vision.
              </span>
            </div>
          </h1>
        ...
        <div className="text-center">
          ...
          <h2
            ...
            style={{ color: colors[200] }}
          >
            <span className="word" data-delay="4200">
              Web
            </span>
            <span className="word" data-delay="4350">
              design
            </span>
            <span className="word" data-delay="4500">
              ·
            </span>
            <span className="word" data-delay="4650">
              Development
            </span>
            <span className="word" data-delay="4800">
              ·
            </span>
            <span className="word" data-delay="4950">
              Brand
            </span>
            <span className="word" data-delay="5100">
              strategy
            </span>
          </h2>
          <div
