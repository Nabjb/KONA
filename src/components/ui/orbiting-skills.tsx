...
const OrbitingSkill = memo(({ config, angle }: OrbitingSkillProps) => {
  ...
  return (
    ...
    >
      <div
        className={`
          relative w-full h-full p-2 bg-[#0a0a1a]/90 backdrop-blur-sm
      ...
      >
        ...
        {isHovered && (
          <div className="absolute -bottom-8 left-1/2 -translate-x-1/2 px-2 py-1 bg-[#030014]/95 backdrop-blur-sm rounded text-xs text-white whitespace-nowrap pointer-events-none border border-white/10">
            {label}
          </div>
        )}
      </div>
...
export default function OrbitingSkills() {
  ...
  return (
    ...
    >
      ...
      <div className="w-16 h-16 bg-gradient-to-br from-blue-500/20 to-indigo-500/20 rounded-full flex items-center justify-center z-10 relative border border-white/10">
        <div className="absolute inset-0 rounded-full bg-blue-500/20 blur-xl animate-pulse"></div>
        <div className="absolute inset-0 rounded-full bg-indigo-500/10 blur-2xl animate-pulse" style={{ animationDelay: '1s' }}></div>
