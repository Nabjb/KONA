            ...
            <section className="container mx-auto px-4 py-12 md:py-24">
                <div className="flex flex-col md:flex-row items-center justify-between gap-12">
                    ...
                    <div className="w-full md:w-1/2 text-center md:text-left">
                        ...
                        <p className="mt-6 text-lg text-white/60 max-w-xl mx-auto md:mx-0">
                            Build high-performance AI apps on-device without the hassle of model compression or edge deployment.
                        </p>
                        <div className="mt-8">
                            <a
                                href="#contact"
                                className="inline-block bg-white text-black font-semibold px-8 py-3 rounded-lg shadow-lg hover:bg-white/90 transition-colors duration-300"
                            >
                                Contact Us
                            </a>
                        </div>
                    ...
                    <div className="w-full md:w-1/2">
                        ...
                        <div className="flex flex-row items-center justify-center gap-4 overflow-x-auto p-4 custom-scrollbar">
